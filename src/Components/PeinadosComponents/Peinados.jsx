            ...
            <div className="flex h-full justify-center items-center ">
                <div className="flex flex-col md:gap-3 lg:gap-4 gap-2 max-w-sm">
                   ...
                   <div className="w-full h-[35vh] min-w-0 relative md:overflow-hidden overflow-visible md:hidden my-2">
                    ...
                    <button className="group flex items-center gap-3 justify-center bg-marron_claro text-carbon_oscuro px-6 py-3 font-light md:text-base lg:text-lg text-sm tracking-[0.15em] hover:bg-transparent hover:text-marron_claro border border-transparent hover:border-marron_claro transition-colors duration-300 mt-5 cursor-pointer">
