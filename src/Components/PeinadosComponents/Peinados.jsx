...
const PinsCard = ({ title }) => {
    return (
        <div className="flex items-center lg:gap-4 border border-marron_claro rounded-full px-3 py-2">
            
            <p className="lg:text-sm text-xs tracking-[0.1em] font-light">{title}</p>
        </div>
    )
}
            ...
            <div className="flex h-full justify-center items-center ">
                <div className="flex flex-col lg:gap-4 gap-2 max-w-sm">
                   ...
                   <div className="w-full h-[35vh] min-w-0 relative md:overflow-hidden overflow-visible md:hidden my-2">
                    ...
                    <button className="group flex items-center gap-3 justify-center bg-marron_claro text-carbon_oscuro px-6 py-3 font-light lg:text-lg text-sm tracking-[0.15em] hover:bg-transparent hover:text-marron_claro border border-transparent hover:border-marron_claro transition-colors duration-300 mt-5 cursor-pointer">
