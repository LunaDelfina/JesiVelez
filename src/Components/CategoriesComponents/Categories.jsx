...
const Categorias = () => {
    return(
        <section className="bg-gradient-to-b from-carbon_oscuro to-carbon_claro h-[100dvh] snap-start flex flex-col justify-center md:px-[15%] px-10 px-6 py-8 md:py-0 lg:gap-0 gap-10 overflow-x-clip">
