        ...
        <section className="bg-gradient-to-t from-carbon_oscuro to-carbon_claro h-[100vh] snap-start md:px-[15%] px-10 flex flex-col overflow-x-clip">
            ...
            <div className="flex flex-1 min-h-0 justify-center items-center flex-col-reverse md:flex-row gap-4">
                <div className="flex flex-col md:gap-4 gap-2 max-w-sm text-sm md:text-base">
                    ...
                    <a
                        href="https://wa.me/5493547598074?text=Hola!%20Quiero%20encontrar%20mi%20tocado%20ideal."
                        target="_blank"
                        rel="noopener noreferrer"
                        className="group flex items-center gap-3 justify-center bg-marron_claro text-carbon_oscuro px-6 py-3 font-light md:text-lg text-sm tracking-[0.15em] hover:bg-transparent hover:text-marron_claro border border-transparent hover:border-marron_claro transition-colors duration-300 mt-5 cursor-pointer w-fit"
                    >
