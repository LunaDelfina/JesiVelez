...
const Reviews = () => {
    ...
    return (
        <section id="Opiniones" className="bg-gradient-to-b from-carbon_oscuro to-carbon_claro h-[100vh] snap-start md:px-[15%] px-10 flex flex-col justify-center gap-6 overflow-x-clip">
